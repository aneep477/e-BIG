...
function onStudentSelectChange() {
    ...
    if (selectedStudentId) {
        ...
        if (selectedStudent) {
            ...
            document.getElementById('selectedStudentClass').textContent = selectedStudent.kelas;
            document.getElementById('selectedStudentSeries').textContent = selectedStudent.siri_big;
